...
cv::Mat CropImage(const cv::Mat& image, int x, int y, int width, int height)
{
    ...
    std::cout << " after adjust roi: " << roi.x << ", " << roi.y << ", " << roi.width << ", " << roi.height << std::endl;
...
int main(int argc, char** argv)
{
    ...
    cv::Mat image_crop = CropImage(image, 960,0,1920,1440);
    ...
    // 最终裁剪为类似480x640的图像
    // cv::Mat image_camera1_crop = CropImage(image_camera1, 960,0,1920,1440);
    // cv::Mat image_camera4_crop = CropImage(image_camera4, 480,0,960,720);
    // cv::imwrite("/home/xihuidong/codetree/repo/visual_mapping_test/avp-15/camera1_test/image_camera1_crop_480x640.png", image_camera1_crop);
    // cv::imwrite("/home/xihuidong/codetree/repo/visual_mapping_test/avp-15/camera1_test/image_camera4_crop_480x640.png", image_camera4_crop);
    // 最终裁剪为360*640的图像
    // cv::Mat image_camera1_crop_360 = CropImage(image_camera1, 640,0,2560,1440);
    // cv::Mat image_camera4_crop_360 = CropImage(image_camera4, 320,0,1280,720);
    // cv::imwrite("/home/xihuidong/codetree/repo/visual_mapping_test/avp-15/camera1_test/image_camera1_crop_360x640.png", image_camera1_crop_360);
    // cv::imwrite("/home/xihuidong/codetree/repo/visual_mapping_test/avp-15/camera1_test/image_camera4_crop_360x640.png", image_camera4_crop_360);
