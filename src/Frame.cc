...
Frame::Frame(const Frame &frame)
    :mpcpi(frame.mpcpi), mpExtractorLeft(frame.mpExtractorLeft), mpExtractorRight(frame.mpExtractorRight),
     ...
     mPreGlobalDescriptors(frame.mPreGlobalDescriptors.clone()), 
     mGlobalDescriptors(frame.mGlobalDescriptors.clone()),
...
Frame::Frame(const cv::Mat &imGray, const double &timeStamp, HFextractor* extractor, GeometricCamera* pCamera, cv::Mat &distCoef, const float &bf, const float &thDepth, Frame* pPrevF, const IMU::Calib &ImuCalib)
    :mpcpi(NULL),
     mpExtractorLeft(extractor),
     mpExtractorRight(static_cast<HFextractor*>(NULL)),
     ...
     mThDepth(thDepth),
     mImuCalib(ImuCalib), 
     mpImuPreintegrated(NULL),mpPrevFrame(pPrevF),mpImuPreintegratedFrame(NULL), mpReferenceKF(static_cast<KeyFrame*>(NULL)), mbIsSet(false), mbImuPreintegrated(false), mpCamera(pCamera),
