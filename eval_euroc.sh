#!/bin/bash
pathDataset='/media/xhd/新加卷/数据集/Euroc' # it is necesary to change it by the dataset path
...
#python3 ./evaluation/evaluate_ate_scale.py ./evaluation/Ground_truth/EuRoC_left_cam/MH01_GT.txt ./evaluation/Euroc/MH01_MONO/trajectory.txt --verbose --save_path ./evaluation/Euroc/MH01_MONO/
